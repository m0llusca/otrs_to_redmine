...
|-----------|----------------|
| OTRS → Redmine | **Create** a new issue or **link** to an existing one. Link writes a short journal: ticket link + agent (no bridge stamp). Optional attachments on create/link. |
