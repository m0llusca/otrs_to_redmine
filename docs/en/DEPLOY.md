...
Ticket mail and notes are **not** pushed to Redmine after create/link. Link/unlink write only a short journal (ticket link + agent), without a bridge stamp. Redmine → OTRS needs the Daemon and `Redmine::InboundSync`.
