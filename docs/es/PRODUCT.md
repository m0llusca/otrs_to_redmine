...
|-----------|------------|
| OTRS → Redmine | **Crear** una incidencia nueva o **vincular** a una existente. El puente escribe una nota breve en ruso con la URL pública del ticket. Adjuntos opcionales en create/link. |
