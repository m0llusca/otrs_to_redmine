...
|-----------|------------|
| OTRS → Redmine | **Crear** una incidencia nueva o **vincular** a una existente. Al vincular: nota breve con enlace del ticket + agente (sin sello del puente). Adjuntos opcionales en create/link. |
